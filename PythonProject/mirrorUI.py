...
"background-color: rgb(0, 0, 0);")
        ...
        self.label_gif.setPixmap(QtGui.QPixmap("img/洛天依_黑.gif"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_weather.setText(_translate("MainWindow", "晴"))
        self.label_weathertips.setText(_translate("MainWindow", "大太阳的不出去运动窝在宿舍干嘛"))
        self.label_time.setText(_translate("MainWindow", "12:00"))
        self.label_date.setText(_translate("MainWindow", "2022年10月1日"))
        self.label_week.setText(_translate("MainWindow", "星期八"))
        self.label_historyhead.setText(_translate("MainWindow", "历史上的今天："))
        self.label_historymsg.setText(_translate("MainWindow", ""))
        self.label_communicate.setText(_translate("MainWindow", "你好呀，我是魔镜小美～"))
        self.label_todohead.setText(_translate("MainWindow", "今日事项"))
        self.label_todomsg.setText(_translate("MainWindow", "无"))
        self.label_headlineshead.setText(_translate("MainWindow", "时事热点"))
        self.label_headlinesmsg.setText(_translate("MainWindow", "今天期末考试!\n"
"明天放假!"))
