...
class FaceFunction:
    def __init__(self):
        ...
        self.APPID = '28705589'
        self.APIKEY = 'kmM6KARrCmCnSMiPvb55fz8G'
        self.SECRETKEY = 'MsUqQHbSuBoHYDUyGuGi8TSKRtGiUW6s'
        self.imgPath = '/home/magicmirror/Desktop/pycharm_project_214/PythonProject/img/cap.jpg'
        self.savePath = '/home/magicmirror/Desktop/pycharm_project_214/PythonProject/img/'
    ...
    def faces_video(self):
        """人脸识别并截图（这里是主要入口函数）"""
        haarcascade_path = r'/home/magicmirror/Desktop/pycharm_project_214/PythonProject/data/haarcascades/haarcascade_frontalface_alt.xml'
        ...
        while self.isFaceVideo:
            ...
            print('gethappy:'+str(self.getHappyFace))
            print('iscamera'+str(self.isFaceVideo))
            if len(faces) > 0:
    ...
    def uploadImg(self, filepath):
        url = 'http://192.168.1.102/MagicMirror/upload_file.php'
