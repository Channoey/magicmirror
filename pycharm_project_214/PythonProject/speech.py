...
class SpeechFunction:
    ...
    def mainSpeechFunc(self):
        if self.allowSpeechFunc:
            ...
            res = self.audioToText('/home/magicmirror/Desktop/pycharm_project_214/PythonProject/audio/record.pcm')      # 语音转文字
            if res:
                print(">> 你说的：", res)
                # msg = self.tencentBot(res)
                # msg = self.tulingBot(res)
                ...
                #     self.robotText = msg
                #     # self.textToAudio(msg, 'audio/text2audio.mp3')   # 文字转语音
                #     res = self.tencentTextToAudio(msg, '/home/magicmirror/Desktop/pycharm_project_214/PythonProject/audio/text2audio.mp3')
                #     if not res:  # 腾讯失败，就用百度
                #         res = self.textToAudio(msg, '/home/magicmirror/Desktop/pycharm_project_214/PythonProject/audio/text2audio.mp3')
                #     if res:
                #         self.playAudio('/home/magicmirror/Desktop/pycharm_project_214/PythonProject/audio/text2audio.mp3')          # 播放语音
                #         while self.checkAudioPlaying():                 # 检查音频播放线程是否结束
                #             time.sleep(1)
            if res == "谁是傻逼？" or res == "谁是傻逼?" or res == "谁是傻逼":
                self.textToAudio("杨宇豪是傻逼，杨宇豪是傻逼，杨宇豪是傻逼，杨宇豪是傻逼，杨宇豪是傻逼！",'/home/magicmirror/Desktop/pycharm_project_214/PythonProject/audio/text2audio.mp3')
                self.playAudio('/home/magicmirror/Desktop/pycharm_project_214/PythonProject/audio/text2audio.mp3')
                while self.checkAudioPlaying():  # 检查音频播放线程是否结束
                    time.sleep(1)
        print("\r\n>> 结束!")
    ...
    def waitUntilAwakened(self):
        model = '/home/magicmirror/Desktop/pycharm_project_214/PythonProject/audio/1.pmdl'  # 唤醒词为 魔镜魔镜
...
def test():
    ...
    if res:
        ...
        speech.textToAudio(msg, '/home/magicmirror/Desktop/pycharm_project_214/PythonProject/audio/text2audio.mp3')     # 文字转语音
...
def test3():
    speech = SpeechFunction()
    speech.TextToPlay("哇，你好开心啊，我已经停止检测了！")
    while speech.checkAudioPlaying():  # 检查音频播放线程是否结束
        time.sleep(1)
    print("\r\n>> 结束!")
